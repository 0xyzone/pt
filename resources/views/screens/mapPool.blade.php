<x-base title="MAP POOL RESULTS">
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .card-reveal {
            ...
            animation-timing-function: cubic-bezier(0.075, 0.82, 0.165, 1); /* ultra-smooth cinematic ease-out */
    ...
    <div id="screen-wrapper" class="w-full h-full min-h-screen {{ $bgType === 'animated' ? 'cyber-bg' : 'bg-transparent' }} relative flex flex-col justify-between overflow-hidden text-slate-100 font-esports select-none">
        ...
        <div class="relative z-10 flex-1 flex px-12 py-6 min-h-0 items-center justify-center">
            ...
            <div class="card-container {{ $containerClass }}">
                @foreach($matches as $index => $match)
                    ...
                    <div class="card-reveal map-row rounded-2xl flex items-center justify-between px-8 py-3 relative overflow-hidden {{ $match->is_completed ? 'completed-row-active' : ($match->is_active ? 'live-row-active' : '') }}" 
                         style="height: {{ $rowHeightPx }}px; animation-delay: {{ $delay }}s;">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-r from-slate-950/96 via-slate-950/88 to-slate-950/96 z-5 pointer-events-none"></div>
                        ...
                        <div class="flex items-center gap-5 z-10 relative pl-2 shrink-0">
                            ...
                            <div class="relative overflow-hidden rounded-xl border-2 {{ $match->is_completed ? 'border-yellow-500/50 shadow-[0_0_15px_rgba(250,204,21,0.2)]' : ($match->is_active ? 'border-emerald-500/60 shadow-[0_0_18px_rgba(16,185,129,0.25)]' : 'border-cyan-500/40 shadow-[0_0_12px_rgba(6,182,212,0.1)]') }} shrink-0 group"
                                 style="width: {{ $useGrid ? 140 : 210 }}px; height: {{ $useGrid ? 85 : 110 }}px;">
                                ...
                                <div class="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-slate-950/20 to-transparent z-5"></div>
                        ...
                        <div class="flex justify-end items-center z-10 relative pr-2" style="width: {{ $rightWidthPx }}px;">
                            @if($match->is_completed && $winner)
                                ...
                                <div class="w-full flex items-center gap-4 bg-slate-950/95 border border-yellow-400/40 rounded-xl p-2.5 shadow-lg relative overflow-hidden">
                                    ...
                                    <div class="absolute inset-0 bg-gradient-to-r from-yellow-500/10 via-transparent to-transparent"></div>
                                    ...
                                    <div class="w-14 h-14 bg-gradient-to-br from-yellow-400 to-yellow-600 border border-yellow-300 rounded-xl flex items-center justify-center p-1 shrink-0 relative shadow-[0_0_15px_rgba(250,204,21,0.25)]">
                                        <div class="w-full h-full bg-slate-950 rounded-lg flex items-center justify-center p-1.5 shadow-inner">
                                            <img src="{{ $winner->logo_image ? asset('storage/' . $winner->logo_image) : asset('img/defult_team_logo.png') }}" 
                                                 class="logo-shine w-9 h-9 object-contain">
                                        </div>
                                        
                                        {{-- Mini WWCD Badge --}}
                                        <div class="wwcd-glow absolute -top-2.5 -right-2 bg-gradient-to-r from-yellow-400 to-amber-500 border border-white/30 px-1 py-0.5 rounded text-[7px] font-black text-slate-950 tracking-wider shadow-md font-hud leading-none">
                                            WWCD
                                        </div>
                                    </div>
                            ...
                            @elseif($match->is_active)
                                ...
                                <div class="w-full flex items-center justify-between bg-emerald-950/20 border border-emerald-500/40 rounded-xl p-2.5 shadow-lg relative overflow-hidden">
                                    <div class="absolute inset-0 bg-grid-tiny opacity-15"></div>
                                    <div class="absolute inset-0 bg-gradient-to-r from-emerald-500/10 via-transparent to-transparent"></div>
                                    ...
                                    <div class="flex items-center gap-3 z-10">
                                        <div class="live-visor bg-gradient-to-r from-emerald-600 to-green-700 border border-white/20 px-2.5 py-1.5 shadow-[0_0_15px_rgba(16,185,129,0.35)] rounded-lg relative shrink-0">
        ...
        <div class="slide-up-footer glass-footer relative z-10 flex items-center justify-between px-12 py-3.5 font-body text-[10px] font-bold text-slate-500 tracking-[0.4em] uppercase">
            ...
            <div class="h-px w-48 shrink-0 bg-gradient-to-r from-transparent via-yellow-400/20 to-transparent"></div>
